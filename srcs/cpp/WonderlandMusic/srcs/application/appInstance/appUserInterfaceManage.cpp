...
bool AppUserInterfaceManage::deleteResource( ) {
	...
	Delete_Resource_App_Core_Ptr( playerWindowCentreWidget );
	Delete_Resource_App_Core_Ptr( playerInfoListWidget );
	Delete_Resource_App_Core_Ptr( playerControlWidget );
	Delete_Resource_App_Core_Ptr( playWindow );
...
bool AppUserInterfaceManage::init( ) {
	...
	Init_Resource_App_Core_Ptr( playWindow );
	Init_Resource_App_Core_Ptr( playerWindowCentreWidget );
	Init_Resource_App_Core_Ptr( playerInfoListWidget );
	Init_Resource_App_Core_Ptr( playerControlWidget );
...
bool AppUserInterfaceManage::initBefore( ) {
	...
	playerWindowCentreWidget = new PlayerWindowCentreWidget;
	playerInfoListWidget = new PlayerInfoListWidget;
	playerControlWidget = new PlayerControlWidget;
	...
	Before_Init_Resource_App_Core_Ptr( playWindow );
	Before_Init_Resource_App_Core_Ptr( playerWindowCentreWidget );
	Before_Init_Resource_App_Core_Ptr( playerInfoListWidget );
	Before_Init_Resource_App_Core_Ptr( playerControlWidget );
...
bool AppUserInterfaceManage::initAfter( ) {
	...
	After_Init_Resource_App_Core_Ptr( playWindow );
	After_Init_Resource_App_Core_Ptr( playerWindowCentreWidget );
	After_Init_Resource_App_Core_Ptr( playerInfoListWidget );
	After_Init_Resource_App_Core_Ptr( playerControlWidget );
...
PlayerInfoListWidget * AppUserInterfaceManage::getPlayerInfoListWidget( ) const {
