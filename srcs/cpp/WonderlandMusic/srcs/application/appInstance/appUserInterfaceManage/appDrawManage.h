...
public:
	...
	virtual bool drawItem( QPainter &painter, const IMusicItem *music_item, const IMusicItemWidthInfo *music_item_width_info, const QFont &font, const int &pos_x, const int &pos_y ) const;
	virtual bool drawItem( QPainter &painter, const std::vector< IMusicItem * > &music_item_vector, const IMusicItemWidthInfo *music_item_width_info, const QFont &font, const int &pos_x, const int &pos_y ) const;
};
