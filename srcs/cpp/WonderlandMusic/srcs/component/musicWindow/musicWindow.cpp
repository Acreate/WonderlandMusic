...
bool MusicWindow::setMusicFavoriteWidget( IMusicFavoriteWidget *const music_favorite_widget ) {
	return musicCentreWidget->setMusicFavoriteWidget( music_favorite_widget );
}
bool MusicWindow::setMusicListWidget( IMusicListWidget *const music_list_widget ) {
	return musicCentreWidget->setMusicListWidget( music_list_widget );
}
bool MusicWindow::setMusicTitleWidget( IMusicTitleWidget *const music_title_widget ) {
	return musicCentreWidget->setMusicTitleWidget( music_title_widget );
}
bool MusicWindow::setMusicDataManage( IMusicDataManage *const music_data_manage ) {
