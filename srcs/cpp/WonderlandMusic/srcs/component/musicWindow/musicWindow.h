...
class MusicWindow : public QMainWindow, public OptionPanel, public IAppJsonData, public IAppResourceCore, public virtual ClassTypeInfoVar {
	Q_OBJECT;
...
public:
	...
	virtual bool setMusicFavoriteWidget( IMusicFavoriteWidget *const music_favorite_widget );
	virtual bool setMusicListWidget( IMusicListWidget *const music_list_widget );
	virtual bool setMusicTitleWidget( IMusicTitleWidget *const music_title_widget );
	virtual bool setMusicDataManage( IMusicDataManage *const music_data_manage );
	...
	virtual bool setMusicCentreWidget( IMusicCentreWidget *music_centre_widget );
};
