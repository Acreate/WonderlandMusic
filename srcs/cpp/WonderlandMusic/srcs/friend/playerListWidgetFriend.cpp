...
bool PlayerListWidgetFriend::deleteDiskMusicFileList( const std::vector< QString > &file_path_info_vector ) {
...
bool PlayerListWidgetFriend::removeListMusicFileList( const std::vector< QString > &file_path_info_vector ) {
	if( playerListWidget == nullptr )
		return false;
