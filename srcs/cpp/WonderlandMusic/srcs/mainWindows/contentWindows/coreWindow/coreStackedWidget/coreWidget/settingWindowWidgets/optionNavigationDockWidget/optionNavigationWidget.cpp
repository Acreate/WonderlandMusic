...
OptionNavigationWidget::OptionNavigationWidget( OptionNavigationDockWidget *parent ) : QWidget( parent ), optionNavigationDockWidget( parent ) {
	...
	connect( pathBtn, &QPushButton::clicked, [this]( ) {
		OptionNavigationWidgetEvent::triggerOptionNavigationWidgetEvent( optionNavigationDockWidget, this, OptionNavigationWidgetEventInfo( OptionNavigationWidgetEventInfo::EventType::Show_Path_Widget ) );
	} );
	connect( aboutBtn, &QPushButton::clicked, [this]( ) {
		OptionNavigationWidgetEvent::triggerOptionNavigationWidgetEvent( optionNavigationDockWidget, this, OptionNavigationWidgetEventInfo( OptionNavigationWidgetEventInfo::EventType::Show_About_Widget ) );
	} );
	pathBtn->move( 0, 0 );
