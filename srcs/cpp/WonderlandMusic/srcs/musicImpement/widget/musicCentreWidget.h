...
public:
	...
	bool setMusicFavoriteWidget( IMusicFavoriteWidget *const music_favorite_widget ) override;
	bool setMusicListWidget( IMusicListWidget *const music_list_widget ) override;
	bool setMusicTitleWidget( IMusicTitleWidget *const music_title_widget ) override;
	bool setMusicDataManage( IMusicDataManage *const music_data_manage ) override;

	bool removeMusicFavoriteWidget( IMusicFavoriteWidget *const music_favorite_widget ) override;
	bool removeMusicListWidget( IMusicListWidget *const music_list_widget ) override;
	bool removeMusicTitleWidget( IMusicTitleWidget *const music_title_widget ) override;
