...
bool PathTools::getAppSettintHomePath( QString &result_app_setting_home_path ) {
...
bool PathTools::getSupperDecodeFileSuffixFilter( QString &result_supper_decode_music_file_suffix_filter ) {
	std::vector< QString > decodeFileSuffix;
	if( PathTools::getSupperDecodeFileSuffix( decodeFileSuffix ) == false )
		return false;
